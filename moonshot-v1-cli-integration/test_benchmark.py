...
#     # Rename File name for testing
#     old_name = MOON_V1_CLI_DIR + "/data/datasets/prompt_injection_jailbreak.json"
#     new_name = MOON_V1_CLI_DIR + "/data/datasets/prompt_injection_jailbreaks.json"
#     # Rename the file
...
#     # Revert Rename File name for testing
#     new_name = MOON_V1_CLI_DIR + "/data/datasets/prompt_injection_jailbreak.json"
#     old_name = MOON_V1_CLI_DIR + "/data/datasets/prompt_injection_jailbreaks.json"
#     # Rename the file
#     os.rename(old_name, new_name)
...
# def test_cli_run_benchmarking_via_run_command_refusal_adapter_brand_reputation_jailbreakbench():
#     # Generate a random number between 0 and 999,999,999 (inclusive)
#     random_number = int(random.random() * 1000000000)
#     dataset_module = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/brand_reputation_jailbreakbench"
#     prefix = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/"
#     dataset_source = "s3-" + dataset_module[len(prefix):]
#     connector_name = "my-gpt-4o-mini"
#     nameOfRunnerName = "my-benchmarking-" + connector_name + "-" + dataset_source + "-" + str(random_number)
...
#     # Generate a random number between 0 and 999,999,999 (inclusive)
#     random_number = int(random.random() * 1000000000)
#     dataset_module = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/brand_reputation_harmbench"
#     prefix = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/"
#     dataset_source = "s3-" + dataset_module[len(prefix):]
#     connector_name = "my-gpt-4o-mini"
#     nameOfRunnerName = "my-benchmarking-" + connector_name + "-" + dataset_source + "-" + str(random_number)
...
#     # Generate a random number between 0 and 999,999,999 (inclusive)
#     random_number = int(random.random() * 1000000000)
#     dataset_module = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/brand_reputation_winobias_variation1"
#     prefix = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/"
#     dataset_source = "s3-" + dataset_module[len(prefix):]
#     connector_name = "my-gpt-4o-mini"
#     nameOfRunnerName = "my-benchmarking-" + connector_name + "-" + dataset_source + "-" + str(random_number)
#     test_config_name = "qa-tests"
#     metric_module = "accuracy_adapter"
...
#     # Generate a random number between 0 and 999,999,999 (inclusive)
#     random_number = int(random.random() * 1000000000)
#     dataset_module = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/brand_reputation_bbq"
#     prefix = "s3://s3-aiss-moonshot-dev-app-lite/data/dataset-mini/"
#     dataset_source = "s3-" + dataset_module[len(prefix):]
#     connector_name = "my-gpt-4o-mini"
#     nameOfRunnerName = "my-benchmarking-" + connector_name + "-" + dataset_source + "-" + str(random_number)
...
#     assert "successfully at:".replace(" ", "") in output_lines
#     assert "data/results/my-benchm".replace(" ", "") in output_lines
#     assert any("alreadyexistsinthe" in line for line in output_lines)
#     check_result_file_exists(MOON_V1_CLI_DIR + "/data/results/" + nameOfRunnerName + ".json")
